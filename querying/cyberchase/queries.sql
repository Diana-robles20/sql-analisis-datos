...
-- DATASET: CYBERCHASE
------------------------------------------------------------------------------------------------------------------------------------
-- Base de datos de episodios de la serie Cyberchase (PBS).
-- Contiene información como título, temporada, número del episodio en la temporada, fecha de emisión, código de producción y tema.
